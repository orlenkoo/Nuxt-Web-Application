    ...
    <b-modal id="modal-1">
        <div class="sidebar-modal-inner">
            <div class="sidebar-about-area">
                <div class="title">
                    <h2>معلومات عنا</h2>
                    <p>حل مرن لمختلف احتياجات أعمال البيع بالتجزئة والضيافة. يتيح الحل نمو الأعمال التجارية بسرعة وبدون عناء دون أي التزام. نحن نقدم إمكانات تكامل متقدمة للتجارة الإلكترونية والمحاسبة والأنظمة الأخرى. الخوادم أو التراخيص الإضافية ليست ضرورية</p>
                </div>
            </div>
                ...
                <div class="contact-info">
                    <div class="contact-info-content">
                        <h2>
                            ...
                            <span>OR</span>
                            <a href="mailto:hello@bionix.com">hello@valeria.com</a>
                        </h2>
