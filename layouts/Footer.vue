                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-footer-widget pl-5">
                        ...
                        <ul class="footer-quick-links">
                            ...
                            <li><NuxtLink to="/projects-one">Products</NuxtLink></li>
                            <li><NuxtLink to="/features">Features</NuxtLink></li>
                            <li><NuxtLink to="/pricing">Prices</NuxtLink></li>
                            <li><NuxtLink to="/services-one">Customer Service</NuxtLink></li>
                            <li><NuxtLink to="/team-one">Inquiry</NuxtLink></li>
                        </ul>
                    </div>
                </div>
