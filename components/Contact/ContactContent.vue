            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="contact-info-box">
                        ...
                        <h3>Email Here</h3>
                        <p><a href="mailto:admin@bionix.com">admin@admin.com</a></p>
                        <p><a href="mailto:info@bionix.com">info@info.com</a></p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="contact-info-box">
                        ...
                        <h3>Location Here</h3>
                        <p><a href="https://goo.gl/maps/Mii9keyeqXeNH4347" target="_blank">AAA Street BBB Road, New York, Canada</a></p>
                    </div>
                </div>
