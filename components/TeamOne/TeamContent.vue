<template>
    <div class="team-area-two ptb-100">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-team-box">
                        <div class="image">
                            <img src="~/assets/images/team/team-14.jpg" alt="team">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-team-box">
                        <div class="image">
                            <img src="~/assets/images/team/team-15.jpg" alt="team">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-team-box">
                        <div class="image">
                            <img src="~/assets/images/team/team-16.jpg" alt="team">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-team-box">
                        <div class="image">
                            <img src="~/assets/images/team/team-17.jpg" alt="team">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-team-box">
                        <div class="image">
                            <img src="~/assets/images/team/team-18.jpg" alt="team">
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="pagination-area">
                        ...
                        <a href="/team-one" class="page-numbers">1</a>
                        <span class="page-numbers current" aria-current="page">2</span>
                        <a href="/team-one" class="page-numbers">3</a>
                        <a href="/team-one" class="page-numbers">4</a>
                        <a href="/team-one" class="next page-numbers">
